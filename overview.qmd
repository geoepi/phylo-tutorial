---
title: "Investigating FMD Sympatric Water Buffalo and Cattle"
...
## Tracer Type Stats  
```{r}
sat_stats <- get_tracer_stats(here("beast/aligned_SAT1.log.txt")) 
...
```
```{r}
sat_mcc.tree <- read.nexus(here("beast/sat1_mcc.tre"))
